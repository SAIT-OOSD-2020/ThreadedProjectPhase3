                ...
                try {
                    ...
                    String sql =
                            "INSERT INTO Customers (CustFirstName, CustLastName, CustAddress, CustCity, CustProv, " +
                                    "CustPostal, CustCountry, CustHomePhone, CustBusPhone, CustEmail, AgentId) VALUES" +
                                    " ('"+txtCustFirstName.getText()+"', '"+txtCustLastName.getText()+"', '"+txtCustAddress.getText()+"', '"+txtCustCity.getText()+"', '"+txtCustProv.getText()+"', '"+ txtCustPostal.getText()+"', '"+txtCustCountry.getText()+"', '"+ txtCustHomePhone.getText()+"','"+txtCustBusPhone.getText()+"', '"+txtCustEmail.getText()+"', '"+txtAgentId.getText()+"')' '";
